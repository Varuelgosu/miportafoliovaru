  ...
  const proyectos = [
    {
      ...
      imagen: `${process.env.PUBLIC_URL}/content/images/a.jpg`,
    ...
    },
    {
      ...
      imagen: `${process.env.PUBLIC_URL}/content/images/b.jpeg`,
    ...
    },
    {
      ...
      imagen: `${process.env.PUBLIC_URL}/content/images/c.png`,
      tecnologias: ['React', 'Node.js', 'CSS'],
    ...
    },
    {
      ...
      imagen: `${process.env.PUBLIC_URL}/content/images/d.png`,
      tecnologias: ['React', 'Node.js', 'CSS'],
    ...
    },
    {
      ...
      imagen: `${process.env.PUBLIC_URL}/content/images/e.png`,
      tecnologias: ['React', 'Node.js', 'CSS'],
